...
public class ApiInvoker {
	...
	public static Object deserialize(String json, String containerType,
		...
		try {
			if ("list".equals(containerType) || "array".equals(containerType)) {
				...
				List response = (List<?>) JsonUtil.getJsonMapper().readValue(
						json, typeInfo);
				return response;
	...
	public String invokeAPI(String host, String path, String method,
			Map<String, String> queryParams, Object objectBody,
		...
		Entity<?> body = Entity.entity(objectBody, contentType);
		...
		Builder builder = client.invocation(
				Link.fromUri(host + path + querystring).build()).accept(
				"application/json");
